...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($con, "INSERT INTO services(title,icon) VALUES('$title', '$filename')");

        if ($result) {
            echo "
    <script>
        alert('Berhasil Tambah Data Services');
        document.location='services';    
    </script>";
        } else {
            echo "
    <script>
        alert('GagalTambah Data Services');
        document.location='services';    
    </script>";
        }
    }
                    ...
                    <div class="card-body">
                        <form method="post" name="form1" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="Nama lengkap" autocomplete="off" required="required" name="title">
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="icon">Icon</label>
                                        <input type="file" class="form-control-file" id="icon" autocomplete="off" required="required" name="icon">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <a href="services" class="btn btn-sm btn-secondary">Kembali</a>
                            </div>
                        </form>
                    </div>
